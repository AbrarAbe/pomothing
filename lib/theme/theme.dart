...
ThemeData darkMode = ThemeData(
  ...
  colorScheme: ColorScheme.dark(
    ...
    onPrimaryContainer: catppuccinMochaText,
    onSecondaryContainer: catppuccinMochaText,
    onTertiaryContainer: catppuccinMochaText,
    onErrorContainer: catppuccinMochaSurface,
  ),
  appBarTheme: const AppBarTheme(
  ...
  iconTheme: const IconThemeData(color: catppuccinMochaPrimary),
);
